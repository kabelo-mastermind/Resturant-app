        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {orders.map((order, index) => (
              ...
              <Link to={`/view_order/${order.order_id}`} className="inline-block px-2 py-1 mr-2 text-xs font-semibold leading-none text-white bg-blue-500 rounded hover:bg-blue-600">View</Link>
