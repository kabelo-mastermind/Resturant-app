...
<div>
  <div className="relative min-h-screen flex items-center">
    {/* Background Image */}
    <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: "url(https://www.macquariecentre.com.au/getmedia/611ebf83-8695-43ad-b78d-ca87902f9b74/L_Restaurant_Shared_Lunch_1.jpg?width=8510&height=5674&ext=.jpg)"}}></div>
  ...
  {/* About Us Section */}
  <section className="container mx-auto px-4 py-8 text-black-500">
    <div className="lg:w-2/3">
      <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-black">About Us</h2>
      <p className="mb-6">At Delicious Eats, we are passionate about creating exceptional dining experiences for our customers. Our restaurant combines the finest ingredients, talented chefs, and a welcoming atmosphere to ensure every visit is memorable.</p>
      <p>We take pride in offering a diverse menu featuring dishes inspired by cuisines from around the world. Whether you&apos;re craving a comforting bowl of pasta, a juicy steak, or a refreshing salad, we have something to satisfy every palate.</p>
    </div>
  </section>
  ...
  <div className="lg:w-2/3">
    ...
    <p className="mb-4">Email: info@deliciouseats.com</p>
